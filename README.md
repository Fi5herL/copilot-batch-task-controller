...
[![version](https://img.shields.io/badge/version-3.0-00d2ff?style=flat-square)](./CHANGELOG.md)
...
| 📎 **網頁截取** | 在任意頁面截取選取文字或整頁內文，一鍵送入指定 Copilot 分頁 |
...
2. 點選 **[安裝腳本](./CopilotBatchTaskController_v3.user.js)** → Tampermonkey 會自動彈出安裝視窗
3. 點「安裝」即完成
